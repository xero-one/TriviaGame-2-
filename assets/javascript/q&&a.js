...
var triviaQuestions = [
{
    ...
    choices: ["Freddy Krueger", "Jason Voorhees", "Diana Kimble", "Pamela Voorhees"],
    rightAnswer: "Pamela Voorhees",
...
},
{
    ...
    choices: ["Cunningham County, New Jersey", "Springwood, California", "Springwood, Ohio","Shades of Death Rd, New Jersey"],
    rightAnswer: "Springwood, Ohio"
...
},
{
    ...
    choices: ["Pinhead", "Jigsaw", "Tall Man", "Scream"],
    rightAnswer: "Pinhead"
...
},
{
    ...
    choices: ["Halloween", "Hellraiser", "Saw", "Alien"],
    rightAnswer: "Saw"
...
},
{
    ...
    choices: ["Final Destination", "The Texas Chainsaw", "Scream", "Psycho"],
    rightAnswer: "Scream"
...
},
{
    ...
    choices: ["The Conjuring", "The Strangers", "The Amityville Horror", "The Hills Have Eyes"],
    rightAnswer: "The Strangers"
...
},
{
    ...
    choices: ["Russia", "Antarctica", "Canada", "Roswell, Mexico"],
...
},
{
    ...
    choices: ["Ken Landwehr's interviews with Dennis Rader", "John Douglas' interviews with David Berkowitz", "Robert Keppel's interviews with Ted Bundy", "Patrick Kennedy's interviews with Jeffrey Dahmer"],
    rightAnswer: "Robert Keppel's interviews with Ted Bundy"
...
},
{
    ...
    choices: ["Jimmy", "Billy", "Willy", "Timmy"],
    rightAnswer: "Billy"
...
},
{
    ...
    choices: ["April Fool's Day", "Happy Birthday to Me", "Hardcore", "Showgirls"],
    rightAnswer: "Showgirls"
...
},
{
    ...
    choices: ["Alice Cooper played his father", "There was a prequel made called 'Freddy’s Nightmares'", "He was wrongfully executed by a mob of townspeople", "He's bastard son of a hundred maniacs"],
    rightAnswer: "He was wrongfully executed by a mob of townspeople"
...
},
{
    ...
    choices: ["Oeuf", "The Encounter", "Home", "The Host"],
    rightAnswer: "Home"
...
},
{
    ...
    choices: ["Naked Woman", "Old Woman", "Tall Man"],
    rightAnswer: "Naked Woman"
...
},
{
    ...
    choices: ["The Exorcist", "Night of the Living Dead", "The Shinning", "Jaws"],
    rightAnswer: "Night of the Living Dead"
...
},
{
    ...
    choices: ["Lubin", "Michael Myers", "Chucky", "Jason Voorhees"],
    rightAnswer: "Jason Voorhees"
...
},
{
    ...
    choices: ["Klien", "Henkel", "Sawyer", "Hooper"],
    rightAnswer: "Sawyer"
...
},
{
    ...
    choices: ["The stragulation of a cat", "The sex scene", "The murder twist", "The child drowning"],
    rightAnswer: "The sex scene"
...
},
{
    ...
    choices: ["I Spit on Your Grave", "Cannibal Holocaust", "The Entity", "All of the above"],
    rightAnswer: "The Entity"
...
},
{
    ...
    choices: ["L'Air du Temps", "Amarige", "J'adore", "Black Orchid"],
    rightAnswer: "L'Air du Temps"
...
},
{
    ...
    choices: ["Nepheron", "Donald Spencer", "John Bradley", "Hell Priest"],
    rightAnswer: "Hell Priest"
...
},
{
    ...
    choices: ["Bruiser", "Dawn of the Dead", "The Crazies", "Return of the Living Dead"],
    rightAnswer: "Return of the Living Dead"
...
},
{
    ...
    choices: ["The original was accidentally auctioned off for $9", "It's real hair", "It's actually a Lee Majors mask painted white", "It's actually a William Shatner mask painted white"],
    rightAnswer: "It's actually a William Shatner mask painted white"
...
},
{
    ...
    choices: ["Call the police", "Survive", "Apply common sense", "Run without tripping"],
    rightAnswer: "Run without tripping"
...
},
{
    ...
    choices: ["Wrong Turn", "The Exorcist", "Don't Breathe", "Silence"],
    rightAnswer: "Don't Breathe"
...
},
{
    ...
    choices: ["During the break-in", "He was bron blind", "In the war", "None of the above"],
    rightAnswer: "In the war"
...
},
{
    ...
    choices: ["--the new flesh.", "--the new chief.", "--the savage new times.", "--the savage new times."],
    rightAnswer: "--the new flesh."
...
},
{
    ...
    choices: ["The Blair Witch Project", "Cloverfield", "Paranormal ACtivity", "Salem Witch Trials"],
    rightAnswer: "The Blair Witch Project"
...
},
{
    ...
    choices: ["Vandelay", "Manderley", "Mandalay", "Cornwall"],
    rightAnswer: "Manderley"
...
},
{
    ...
    choices: ["Poltergeist", "Mockingbird", "Terrified", "IT"],
    rightAnswer: "Mockingbird"
...
},
{
    ...
    choices: ["Wait Until Dark", "Repulsion", "Eyes Without a Face", "Cabin Fever"],
    rightAnswer: "Wait Until Dark"
...
},
{
    ...
    choices: ["Under the Skin","Species", "It Comes at Night", "10 Cloverfield Lane"],
    rightAnswer: "10 Cloverfield Lane"
...
},
{
    ...
    choices: ["Poltergeist", "Hellraiser", "The Exorcist", "The Amityville Horror (original movie)"],
    rightAnswer: "Poltergeist"
...
},
{
    ...
    choices: ["Faces of Death", "Snuff", "Cannibal Holocaust", "Thriller - A Cruel Picture"],
    rightAnswer: "Cannibal Holocaust"
...
},
{
    ...
    choices: ["Azazel", "Pazuzu", "Abaddon", "Tannin"],
    rightAnswer: "Pazuzu"
...
},
{
    ...
    choices: ["Telekinesis", "Pyrokinesis", "Mind Control", "Immortality"],
    rightAnswer: "Telekinesis"
...
},
{
    ...
    choices: ["Wishmaster", "Urban Legends", "Candyman", "Green Mile"],
    rightAnswer: "Candyman"
...
},
{
    ...
    choices: ["Interview with the Vampire", "Shadow of the Vampire", "Shade of the Bat", "Vampires and Demons"],
    rightAnswer: "Shadow of the Vampire"
...
},
{
    ...
    choices: ["The Conjuring", "The Conjuring 2", "Insidious", "Annabelle"],
    rightAnswer: "The Conjuring"
...
},
{
    ...
    choices: ["Chicago", "Baltimore", "New York City", "Detroit"],
    rightAnswer: "Detroit"
...
},
{
    ...
    choices: ["She fell when her line was severed", "Crawlers ate her", "Sarah bludgeoned her", "Juno stabbed her"],
    rightAnswer: "Sarah bludgeoned her"
...
},
{
    ...
    choices: ["The Boogie Man", "Bughuul", "Mr. Boogie", "All the above"],
...
},
{
    ...
    choices: ["Paranormal Activity", "A Bugs Life", "Grave Encounters", "Final Destination"],
    rightAnswer: "Grave Encounters"
